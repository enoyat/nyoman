...
<div class="row">
	<div class="col-md-12 col-lg-4">
		 <div class="img-responsive" id="viewgambar"><img src="{{ asset('assets/inventory/'.$key->foto) }}"  width="350px"></div>
<?php foreach ($key->get_foto as $key2 ) {
        ?>  

            <a data-toggle="modal" data-target="#global-modal">
<div class="img-thumbnail img-responsive" style="width: 75px" id="view_<?php echo $key2->kdfoto;?>" ><img src="{{ asset('assets/inventory/'.$key2->foto) }}" class="img-responsive" ></div>
            </a>
	...
	<div class="col-md-12 col-lg-8">
      ...
      <div id='soalBtn' class='btn btn-warning btn-sm' title="Masukkan Keranjang"><span class='glyphicon glyphicon-shopping-cart'></span> Masukkan Kerangjang</div></a>
     
	</div>
</div>
<?php $i++; } ?>
<br>
<button class='btn btn-info btn-sm' onclick="goBack()"><span class="glyphicon glyphicon-chevron-left"></span></button>
<br>
<br>
