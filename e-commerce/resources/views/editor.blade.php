<script src="{{ asset('/assets/tinymce/js/tinymce/tinymce.dev.js') }}"></script>
<script src="{{ asset('/assets/tinymce/js/tinymce/plugins/table/plugin.dev.js') }}"></script>
<script src="{{ asset('/assets/tinymce/js/tinymce/plugins/paste/plugin.dev.js') }}"></script>
<script src="{{ asset('/assets/tinymce/js/tinymce/plugins/spellchecker/plugin.dev.js') }}"></script>
<script>
	tinymce.init({
		selector: "textarea",
		theme: "modern",
