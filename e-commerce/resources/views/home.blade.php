        ...
        <div class="container">
            <div class="row">
                <div class="categories__slider owl-carousel">
                    <?php foreach ($kategori as $key) { ?>  
                    <div class="col-lg-3">
                        <div class="categories__item set-bg" data-setbg="{{ asset('img/categories/'.$key->icon) }}">
                            <h5><a href="{{ URL::to('home/kategori/'.$key->kdkategori) }}">{{ $key->namakategori }}</a></h5>
                        </div>
                    </div>
                    <?php } ?>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 mix oranges fresh-meat">
                    <div class="featured__item">
                        ...
                        <div class="featured__item__text">
                            <h6><a href="{{ route('barang',$fiturs->kdbarang) }}">{{ $fiturs->namabarang }}</a></h6>
                            <h5>Rp. {{ number_format($fiturs->hargajual,"0",",",".") }}</h5>
                        </div>
                    </div>
                </div>
                @endforeach
                ...
                <div class="row featured__filter">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 mix oranges fresh-meat">
                        <div class="featured__item">
                            ...
                            <div class="featured__item__text">
                                <h6><a href="{{ route('barang',$product->kdbarang) }}">{{ $product->namabarang }}</a></h6>
                                <h5>Rp. {{ number_format($product->hargajual,"0",",",".") }}</h5>
                            </div>
                        </div>
                    </div>
                    @endforeach
